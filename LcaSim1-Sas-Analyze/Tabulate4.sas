LIBNAME cond4 "C:\Documents and Settings\jjd264\My Documents\Paper-DziakCoffmanLanzaLi2011\LcaSim1-Sas4\Data";
%LET truesize = 4;

DATA temp1;  SET cond4.out1; WHERE log_likelihood>-99999999 & total_n < 3200; n = total_n; rep = rep; ll1 = log_likelihood;  gsq1 = g_squared;  aic1 = aic; abic1 = abic; caic1 = caic; bic1 = bic;  KEEP n rep ll1 gsq1 aic1 abic1 caic1 bic1;  RUN;
DATA temp2;  SET cond4.out2; WHERE log_likelihood>-99999999& total_n < 3200; n = total_n; rep = rep; ll2 = log_likelihood;  gsq2 = g_squared;  aic2 = aic; abic2 = abic; caic2 = caic; bic2 = bic;  KEEP n rep ll2 gsq2 aic2 abic2 caic2 bic2;  RUN;
DATA temp3;  SET cond4.out3; WHERE log_likelihood>-99999999& total_n < 3200; n = total_n; rep = rep; ll3 = log_likelihood;  gsq3 = g_squared;  aic3 = aic; abic3 = abic; caic3 = caic; bic3 = bic;  KEEP n rep ll3 gsq3 aic3 abic3 caic3 bic3;  RUN;
DATA temp4;  SET cond4.out4; WHERE log_likelihood>-99999999& total_n < 3200; n = total_n; rep = rep; ll4 = log_likelihood;  gsq4 = g_squared;  aic4 = aic; abic4 = abic; caic4 = caic; bic4 = bic;  KEEP n rep ll4 gsq4 aic4 abic4 caic4 bic4;  RUN;
DATA temp5;  SET cond4.out5; WHERE log_likelihood>-99999999& total_n < 3200; n = total_n; rep = rep; ll5 = log_likelihood;  gsq5 = g_squared;  aic5 = aic; abic5 = abic; caic5 = caic; bic5 = bic;  KEEP n rep ll5 gsq5 aic5 abic5 caic5 bic5;  RUN;
DATA temp6;  SET cond4.out6; WHERE log_likelihood>-99999999& total_n < 3200; n = total_n; rep = rep; ll6 = log_likelihood;  gsq6 = g_squared;  aic6 = aic; abic6 = abic; caic6 = caic; bic6 = bic;  KEEP n rep ll6 gsq6 aic6 abic6 caic6 bic6;  RUN;
DATA tempSSE; SET cond4.sse; WHERE rep > 0 & n < 3200; n = n; rep = rep; sse1=col1; sse2=col2; sse3=col3; sse4=col4; sse5=col5; sse6=col6; keep rep n sse1-sse6; run;
...
PROC EXPORT DATA= meanpicks_out
            OUTFILE= "C:\Documents and Settings\jjd264\My Documents\Paper-DziakCoffmanLanzaLi2011\LcaSim1-Sas-Analyze\results4.txt"  
            DBMS=TAB REPLACE;
RUN;
