%let path=   C:\Documents and Settings\jjd264\My Documents\Paper-DziakCoffmanLanzaLi2010\LcaSim1-Sas4\;
LIBNAME lca "C:\Documents and Settings\jjd264\My Documents\Paper-DziakCoffmanLanzaLi2010\LcaSim1-Sas4\Data";
...
%MACRO SimulateLca; 
    %DO condition = 1 %TO &ncond; 
        DATA _NULL_;
            condition = &condition;
            n_total = (condition-1) * 200;
            IF condition = 1 THEN n_total = 100;
